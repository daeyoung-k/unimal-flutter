...
/// 말풍선 네이티브 minZoom — 클러스터링 구간(≤16)과의 공존 금지 하드 가드.
/// 줌아웃 제스처 중 idle(sync) 전에 클러스터러가 재편성될 때, 충돌 숨김이
/// 켜진 말풍선이 살아 있으면 새 클러스터 마커가 숨김 고착돼 사라진다
/// (2026-07-19 z15.6 마커 소실, 재시작으로만 복구). 네이티브가 이 줌 아래로
/// 내려가는 즉시 말풍선을 숨겨 Dart 타이밍과 무관하게 차단한다.
/// 값은 클러스터링 상한(16)보다 크고 exit(16.3)보다 작게.
const double kBubbleMinZoom = 16.1;
