...
class _SignupScreensState extends State<SignupScreens> {
  ...
  void _checkNicknameDuplicate() {
    ...
    final List<String> badWords = [
      '씨발', '개새끼', '병신', '미친', '좆', '시발', '개새기', '병신새끼', '시펄', '새끼', '썅', '느금', '섹스', '강간',
      '미친새끼', '좆같은', '시발놈', '개새끼야', '병신아', '미친놈', '로리', '자지', '보지', '후장', '좆', '섹', '빠구리', '보빨', '운지', 
      '좆만한', '시발거', '개새끼같은', '병신같은', '미친같은', '좆같은놈', '일베', '여시', '오랄'
    ];
    
    final String nickname = _nicknameController.text.toLowerCase();
